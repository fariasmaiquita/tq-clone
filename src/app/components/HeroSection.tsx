...
export default function HeroSection() {
    ...
    return (
        <section className="has-bg-img bg-black/40 min-[1200px]:h-dvh max-[1200px]:min-[810px]:h-[calc(100dvh_-_58px)] max-[810px]:h-[86dvh] relative text-white overflow-hidden">
            ...
            <h2 className="absolute z-10 max-w-[582px] w-full min-[810px]:px-[20px] px-[15px] min-[810px]:top-1/2 top-[131px] transform min-[810px]:-translate-y-1/2 min-[1200px]:text-[60px] min-[810px]:text-[48px] text-[38px] tracking-[-0.03em] font-semibold text-balance">
