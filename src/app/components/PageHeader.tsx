...
export default function PageHeader({initBgOpaque = true}: PageHeaderProps) {
    ...
    return (
        <header className={`fixed z-30 inset-x-0 min-[810px]:px-[20px] px-[15px] min-[810px]:h-[58px] h-[49px] grid items-center min-[1200px]:grid-cols-3 grid-cols-2 gap-[20px] font-semibold min-[810px]:text-[18px] text-[14px] tracking-[-0.03em] leading-none ${initBgOpaque ? "min-[1200px]:bg-white" : "min-[1200px]:text-white"} max-[1200px]:bg-white`}>
            <div className="">
